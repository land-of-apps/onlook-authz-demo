...
describe('project procedures called by a signed in user who is not a member', () => {
    ...
    test('project.update called by a non-member', async () => {
    ...
    test('project.delete called by a non-member', async () => {
...
describe('project tag and screenshot procedures', () => {
    ...
    test('project.addTag called by a non-member', async () => {
        const code = await errorCodeOf(
    ...
    test('project.removeTag called by a non-member', async () => {
        const code = await errorCodeOf(
